...
public static void startInseserver(int portNum)  throws RemoteException{
    ...
    try{
        ...
        ServerInse.inputValues("FALL");
        ServerInse.inputValues("WINTER");
        ServerInse.inputValues("SUMMER");
     }// end try
     catch (Exception re) {
