...
public class ClientCheck {
   ...
   public void inputValue(String []args) throws RemoteException,SecurityException,IOException, InputMismatchException, InvalidName{
   ...
   public void rmiAdvisor(String idvalue,String []args) throws SecurityException, IOException, InputMismatchException, InvalidName{
	   ...
	   case "1":
		   ...
		   if (advisordepart.equals(coursedepart)){
			   boolean addresult=intercorba.addCourse(courseid,semester,capacity);
	   ...
	   case "2":
		   ...
		   if (advisordeprt.equals(coursedeprt)){
			   boolean removeresult =intercorba.removeCourse(courseid,semester); 
	   ...
	   case "3":
		   ...
		   if (advisdepart.equals("COMP")){
			   semester+='C';
			   String result=intercorba.listCourseAvailability(semester.toUpperCase().trim());
   ...
   public void rmiStudent(String idvalue,String []args) throws InputMismatchException, SecurityException, IOException, InvalidName  {
	   ...
	   case "1":
		   ...
		   if (flagsem){
		   String result=intercorba.enrolCourse(idvalue,courseid,semester);
	   ...
	   case "2":
		   ...
		   courseid=scan.next().toUpperCase().trim();
		   boolean resultdrop=intercorba.dropCourse(idvalue,courseid);
	   ...
	   case "3":
		   ...
		   String resultschedule=intercorba.getClassSchedule(idvalue);
	   ...
	   case "4":
		   ...
		   String resultswap=intercorba.swapCourse(idvalue,courseidold,courseidnew);
   ...
   public void checkClient(String inputvalue,String []args) throws RemoteException,SecurityException,IOException, InputMismatchException, InvalidName{
   ...
   public void checkserver(String inputvalue,String []args) throws InputMismatchException, SecurityException, IOException, InvalidName{
